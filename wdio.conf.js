...
exports.config = {
  ...
  suites: {
    suite0: ['./test/specs/feed/**/*.js'],
    suite1: ['./test/specs/geolocation/**/*.js'],
    suite2: ['./test/specs/comment-panel-verification/**/*.js'],
    suite3: ['./test/specs/feed-detail-view/**/*.js'],
    suite4: ['./test/specs/convo-chat/**/*.js'],
    suite5: ['./test/specs/feed-search/**/*.js'],
    suite6: ['./test/specs/admin-panel/**/*.js'],
    suite7: ['./test/specs/in-feed-menu/**/*.js'],
    suite8: ['./test/specs/user-profile-view/**/*.js'],
    suite9: ['./test/specs/geo-tagging/**/*.js'],
    suite10: ['./test/specs/trending-hashtags/**/*.js'],
    suite11: ['./test/specs/groups/**/*.js'],
    suite12: ['./test/specs/left-panel/**/*.js'],
    suite13: ['./test/specs/polls/**/*.js'],
    suite14: ['./test/specs/login/**/*.js'],
    suite15: ['./test/specs/inline-insert/**/*.js'],
    suite16: ['./test/specs/post acknowledgment/**/*.js'],
    suite17: ['./test/specs/toggle-feed/**/*.js'],
    suite18: ['./test/specs/gallery-view/**/*.js'],
    suite19: ['./test/specs/restrict-group-creation/**/*.js'],
    suite20: ['./test/specs/custom-fields/**/*.js'],
    suite21: ['./test/specs/app-settings/**/*.js'],
    suite22: ['./test/specs/notifications/**/*.js'],
    suite23: ['./test/specs/manage-acknowledge-post-creators/**/*.js'],
    suite24: ['./test/specs/password-reset/**/*.js'],
    suite25: ['./test/specs/signup/**/*.js'],
    suite26: ['./test/specs/onboarding flow/**/*.js'],
    suite27: ['./test/specs/integrations/**/*.js'],
    suite28: ['./test/specs/cloud sync/**/*.js'],
    suite29: ['./test/specs/disable-further-sharing/**/*.js'],
    suite30: ['./test/specs/group directory/**/*.js'],
    suite31: ['./test/specs/gallery view for posts/**/*.js'],
    suite32: ['./test/specs/imap integration/**/*.js'],
    suite33: ['./test/specs/posts creation/**/*.js'],
    suite34: ['./test/specs/feed checking/**/*.js'],
    suite35: ['./test/specs/feed checking search/**/*.js'],
    suite36: ['./test/specs/sign up for chat/**/*.js'],
    suite37: ['./test/specs/csv reading/**/*.js'],
    suite38: ['./test/specs/Groups deletion/**/*.js'],
    suite39: ['./test/specs/integrations deletion/**/*.js'],
    suite40: ['./test/specs/unified chat/**/*.js'],
    smokeSuite: [
      './test/specs/posts creation/**/*.js',
      './test/specs/imap integration/**/*.js',
      './test/specs/groups gcp/**/*.js',
      './test/specs/feed gcp/**/*.js',
      './test/specs/notifications gcp/**/*.js',
      './test/specs/toggle feed gcp/**/*.js',
      './test/specs/signup gcp/**/*.js',
      './test/specs/login gcp/**/*.js',
      './test/specs/convo-chat gcp/**/*.js',
      './test/specs/integrations gcp/**/*.js'
    ],
